...
function clearSelected() {
    ...
    if (selectedInfo) {
        selectedInfo.textContent = 'Selecione uma data';
    }
...
// Converte busy events para marcação por weekday+hour
...
// Inicialização - deve ser chamada quando os dados estão disponíveis
function initAvailability(availabilityRaw, busyEvents) {
    let availabilityObj = {};
    try {
        if (!availabilityRaw) {
            availabilityObj = {};
